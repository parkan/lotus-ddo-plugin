module github.com/filecoin-project/lotus-ddo-plugin
...
require (
	...
	github.com/filecoin-project/lotus v1.34.2
...
replace (
	...
	github.com/filecoin-project/test-vectors => ../lotus/extern/test-vectors
)
